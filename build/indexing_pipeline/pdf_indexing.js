        ...
        return __generator(this, function (_k) {
            switch (_k.label) {
                case 0:
                    ...
                    return [
                        4 /*yield*/,
                        sourcesDB.get('SELECT * FROM pdfTable WHERE path = ?', [
                            file,
                        ]),
                    ]
                case 1:
                ...
                case 5:
                    ...
                    return [2 /*return*/]
                case 6:
                    return [4 /*yield*/, pdfDoc_1.getMetadata()]
                case 7:
                    metaData = _k.sent()
                ...
                case 8:
                    ...
                    sortedHeights = Object.keys(heightCounts_1)
                        .map(Number)
                        .sort(function (a, b) {
                            return heightCounts_1[b] - heightCounts_1[a]
                        })
                    paragraphHeight_1 = sortedHeights[0]
                    headingHeights = sortedHeights.slice(1)
                    headingHeights.sort(function (a, b) {
                    ...
                    for (
                        i = 0;
                        i <
                        (textSections_1 === null || textSections_1 === void 0
                            ? void 0
                            : textSections_1.length);
                        i++
                    ) {
                        textSegment = textSections_1[i]
                        matchingTextElement = void 0
                        if (
                            (textSegment === null || textSegment === void 0
                                ? void 0
                                : textSegment.transform[0]) ===
                                ((_a = textSections_1[i - 1]) === null ||
                                _a === void 0
                                    ? void 0
                                    : _a.transform[0]) ||
                            (typeof (textSegment === null ||
                            textSegment === void 0
                                ? void 0
                                : textSegment.transform[0]) === 'number' &&
                                (textSegment === null || textSegment === void 0
                                    ? void 0
                                    : textSegment.transform[0]) <=
                                    paragraphHeight_1 &&
                            ...
                            if (tempGroup.length > 10) {
                                pdfText.push(
                                    ((_j = {}),
                                    (_j[matchingTextElement] =
                                        tempGroup.replace(/(?<!\s)-\s/g, '')),
                                    _j),
                                )
                            }
                    ...
                    if (!title) {
                        ...
                        itemWithHeading2 = firstFiveItems.find(function (item) {
                            return 'Heading2' in item
                        })
                        title = itemWithHeading2
                            ? itemWithHeading2['Heading2']
                            : null
