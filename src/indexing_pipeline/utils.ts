...
export async function splitContentInReasonableChunks(
    contentText: string,
): Promise<string[]> {
...
export async function cleanFullHTML(fullHTML: string): Promise<string> {
...
export async function extractEntitiesFromText(
    text: string,
    entityExtractionFunction: (text: string) => Promise<Entity[]>,
): Promise<string[]> {
    // Analyse with english language statistics
    const tagger: posTagger = new posTagger()
    const taggedText: TaggedItem[] = tagger.tagSentence(text)
    // Analyse with english language statistics
